  ...
  return (
    <Layout>
      <div className="bg-white">
        <div className="mx-auto max-w-2xl py-10 px-4 sm:py-18 sm:px-6 lg:max-w-7xl lg:px-8">
          <h2 className="text-2xl font-bold tracking-tight text-gray-900">Lelang yang akan datang</h2>
